...
<div class="2xl:container 2xl:mx-auto">
    <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-24 md:gap-10 gap-12 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        ...
        <div class="flex space-x-4">
            ...
            <div>
                <p class="text-xl dark:text-black leading-5 font-semibold text-gray-800">Free Shipping</p>
                <p class="text-base leading-6 dark:text-black font-normal text-gray-600 mt-3">Free shipping on orders above $100</p>
            </div>
        </div>
        ...
        <div class="flex space-x-4">
            ...
            <div>
                <p class="text-xl dark:text-black leading-5 font-semibold text-gray-800">Support 24/7</p>
                <p class="text-base leading-6 dark:text-black font-normal text-gray-600 mt-3">Contact us 24 hours a day at care@supprt.com</p>
            </div>
        </div>
        ...
        <div class="flex space-x-4">
            ...
            <div>
                <p class="text-xl dark:text-black leading-5 font-semibold text-gray-800">Money Back Guarantee</p>
                <p class="text-base leading-6 dark:text-black font-normal text-gray-600 mt-3">You can return the product within 30 days.</p>
            </div>
        </div>
    </div>
</div>
